...
var FabricCAServices = class extends BaseClient {
	...
	enroll(req) {
		...
		return new Promise(function (resolve, reject) {
			...
			console.log("+++++++++++++++++++++++++++")
			console.log(self.getCryptoSuite())
			console.log("+++++++++++++++++++++++++++")
			self.getCryptoSuite().generateKey(opts)
				.then(
					function (privateKey) {
						...
						try {
							console.log("dam it" + req.enrollmentID)
...
var FabricCAClient = class {
	...
	register(enrollmentID, enrollmentSecret, role, affiliation, maxEnrollments, attrs, signingIdentity) {
		console.log("akakakakakakakaka",enrollmentID,"\nakakakakakakakaka", enrollmentSecret,"\nakakakakakakakaka", role,"\nakakakakakakakaka", affiliation,"\nakakakakakakakaka", maxEnrollments,"\nakakakakakakakaka", attrs,"\nakakakakakakakaka", signingIdentity)
		var self = this;
	...
	generateAuthToken(reqBody, signingIdentity) {
		...
		if (reqBody) {
			...
			console.log("dldldldldldld=", this._cryptoPrimitives)
		} else {
			bodyAndcert = '.' + cert;
		}
